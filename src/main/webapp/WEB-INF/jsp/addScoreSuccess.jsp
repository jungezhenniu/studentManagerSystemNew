...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <h4>学生姓名:</h4>    ${student.name}   <br>
            <h4>学科名及分数</h4>

                <c:forEach items="${scoreList}" var="score">
                    <tr>
                        <td>${score.subject.name}:${score.scoreValue}</td><br>
                    </tr>

                </c:forEach>
            <h4>学生平均分:</h4>${student.avgScore}
    </div>

        <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/student/studentList" method="post">
