...
<head>
    ...
    <script type="text/JavaScript">
        function StudentUpdateSubmit(){
            ...
            var name=document.studentUpdate.name.value;
            if(name==null||name=="")
                alert("请填写学生姓名");

            var number=document.studentUpdate.number.value;
            if(number==null||number=="")
                alert("请填写学生学号");

            var gender=document.studentUpdate.gender.value;
            if(gender==null||gender=="")
                alert("请填写学生性别");

            var file=document.studentUpdate.file.value;
            if(file==null||file=="")
                alert("请上传学生照片");

            var birthday=document.studentUpdate.birthday.value;
            if(birthday==null||birthday=="")
                alert("请填写学生生日");

            else
                document.studentUpdate.submit();
        }
    </script>
...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/student/update" method="post"
                  enctype="multipart/form-data" name="studentUpdate">
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 姓名 </label>

                    <div class="col-sm-9">
                        <input type="text" id="form-field-1" value="${student.name}" name="name" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" id="form-field-2" name="number" value="${student.number}" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        男<input type=radio name="gender" value="男"checked>&nbsp&nbsp女<input type=radio name="gender" value="女">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-4"> 照片上传 </label>

                    <div class="col-sm-9">
                        <div id="dropzone">

                            <div class="fallback">
                                <input id = "form-field-4" name="file" type="file"  />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="input-group input-group-sm">
                                <input type="text" id="datepicker" name="birthday" value="${student.birthday}" class="form-control" />
                ...
                <div class="clearfix form-actions">
                    <div class="col-md-offset-3 col-md-9">
                        <button class="btn btn-info" type="button" onclick="StudentUpdateSubmit()">
