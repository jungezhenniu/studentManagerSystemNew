...
<head>
	...
	<script type="text/JavaScript">
        function studentAddSubmit(){
            var name=document.studentAdd.name.value;
            if(name==null||name=="")
                alert("请填写学生姓名");

            var number=document.studentAdd.number.value;
            if(number==null||number=="")
                alert("请填写学生学号");

            var gender=document.studentAdd.gender.value;
            if(gender==null||gender=="")
                alert("请填写学生性别");

            var file=document.studentAdd.file.value;
            if(file==null||file=="")
                alert("请上传学生照片");

            var birthday=document.studentAdd.birthday.value;
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/student/save" method="post" enctype="multipart/form-data"
							  name="studentAdd">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<input type="text" id="form-field-2" name="number" placeholder="学号" class="col-xs-10 col-sm-5" />
								</div>
							</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info" type="button" onclick="studentAddSubmit()">
