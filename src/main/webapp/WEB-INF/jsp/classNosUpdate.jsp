...
<head>
    ...
    <script type="text/JavaScript">
        function classNosUpdateSubmit(){

            var name=document.classNosUpdate.name.value;
            if(name==null||name=="")
                alert("请填写班级名称");

            else
                document.classNosUpdate.submit();
        }
    </script>
...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/classNos/update" method="post"
            name="classNosUpdate"
            >
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="form-field-1" value="${classNos.name}" name="name" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                ...
                <div class="clearfix form-actions">
                    <div class="col-md-offset-3 col-md-9">
                        <button class="btn btn-info" type="button" onclick="classNosUpdateSubmit()">
