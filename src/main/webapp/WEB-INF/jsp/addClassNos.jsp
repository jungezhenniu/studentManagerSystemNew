...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/student/addClassNos/${id}" method="post">
                <c:forEach  items="${classNosList}" var="classNos">
                    ${classNos.name}:<input type="radio" name="classNosId" value="${classNos.classNosId}"/><br>
                </c:forEach>
