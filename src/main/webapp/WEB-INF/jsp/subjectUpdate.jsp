...
<head>
    ...
    <script type="text/JavaScript">
        function subjectUpdateSubmit(){

            var name=document.subjectUpdate.name.value;
            if(name==null||name=="")
                alert("请填写学科名");

            else
                document.subjectUpdate.submit();
        }
    </script>
...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/subject/update" method="post"
            name="subjectUpdate">
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 学科名称 </label>

                    <div class="col-sm-9">
                        <input type="text" id="form-field-1" value="${subject.name}" name="name" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                ...
                <div class="clearfix form-actions">
                    <div class="col-md-offset-3 col-md-9">
                        <button class="btn btn-info" type="button" onclick="subjectUpdateSubmit()">
