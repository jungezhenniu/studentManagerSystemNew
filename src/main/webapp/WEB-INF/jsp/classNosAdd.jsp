...
<head>
	...
	<script type="text/JavaScript">
        function classNosAddSubmit(){

            var name=document.classNosAdd.name.value;
            if(name==null||name=="")
                alert("请填写班级名称");

            else
                document.classNosAdd.submit();
        }
	</script>
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/classNos/save" method="post"
						name="classNosAdd">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 班级名称 </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="班级名称" name="name" class="col-xs-10 col-sm-5" />
								</div>
							</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info" type="button" onclick="classNosAddSubmit()">
