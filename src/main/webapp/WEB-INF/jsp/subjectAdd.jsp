...
<head>
	...
	<script type="text/JavaScript">
        function subjectAddSubmit(){

            var name=document.subjectAdd.name.value;
            if(name==null||name=="")
                alert("请填写学科名");

            else
                document.subjectAdd.submit();
        }
	</script>
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/subject/save"
							  method="post" name="subjectAdd">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 学科名称 </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="学科名称" name="name" class="col-xs-10 col-sm-5" />
								</div>
							</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info" type="button" onclick="subjectAddSubmit()">
