...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/subject/chooseSubject" method="post">
                <c:forEach  items="${subjectList}" var="subject">
                    <input  type="checkbox" name="nameArray" value="${subject.subjectId}"/>${subject.name}<br>
                </c:forEach>
