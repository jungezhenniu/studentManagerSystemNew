									...
									<div class="col-xs-12">
										<div class="table-responsive">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<c:otherwise>
														<c:forEach items="${myPage}" var="subject" varStatus="obj" >
															<tr>
																<td>${obj.index+1}</td>

																<td>${subject.name}</td>

																<td>${subject.studentSet.size()}</td>

																<td>
																	<a href="${pageContext.request.contextPath}/subject/getSubjectAvgScore/${subject.subjectId}">平均分</a>
																</td>

																<td>
																	<a href="${pageContext.request.contextPath}/subject/updateSubject/${subject.subjectId}">修改</a>
																</td>
																<td>
																	<a href="${pageContext.request.contextPath}/subject/deleteSubject/${subject.subjectId}">删除</a>
																</td>
															<tr>
														</c:forEach>
													</c:otherwise>
								...
								<table border="0" cellspacing="0" cellpadding="0" align="center">
									<tr>
										<td align="right">
											<span>
												<ul class="pagination">
													<li><a href="${pageContext.request.contextPath}/subject/toSave">添加学科</a></li>
												</ul>
											</span>
									...
									<c:if test="${pageNos>0 }">
										<a href="${pageContext.request.contextPath}/subject/subjectList?pageNos=0" >首页</a>
										<a href="${pageContext.request.contextPath}/subject/subjectList?pageNos=${pageNos-1 }">上一页</a>
									</c:if>
									<c:if test="${pageNos <countPage-1 }">
										<a href="${pageContext.request.contextPath}/subject/subjectList?pageNos=${pageNos+1 }">下一页</a>
										<a href="${pageContext.request.contextPath}/subject/subjectList?pageNos=${countPage-1 }">末页</a>
									</c:if>
								</table>
								<form action="${pageContext.request.contextPath}/subject/subjectList">
